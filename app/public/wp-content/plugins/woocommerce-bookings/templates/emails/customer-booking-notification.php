...
// Check if the request is for an email preview.
$email_preview = 'email_preview' === $booking->get_status();
?>

<?php echo isset( $notification_message ) ? esc_html( wptexturize( $notification_message ) ) : ''; ?>
...
<table cellspacing="0" cellpadding="6" style="width: 100%; border: 1px solid #eee;" border="1" bordercolor="#eee">
	<tbody>
		<tr>
			...
			<td style="text-align:left; border: 1px solid #eee;"><?php echo $email_preview ? esc_html( 'Dummy Product' ) : esc_html( $booking->get_product()->get_title() ); ?></td>
		</tr>
		<tr>
		...
		if ( ! $email_preview && $booking->has_resources() && $resource ) :
			?>
			<tr>
