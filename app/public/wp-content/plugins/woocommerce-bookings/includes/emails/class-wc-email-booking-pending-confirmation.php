 ...
 *
 * An email sent to the user when a booking is pending confirmation.
 */
class WC_Email_Booking_Pending_Confirmation extends WC_Email {
	...
	public function __construct() {
		...
		// Set email group for WooCommerce 10.3.0+.
		// This property exists since WC 10.3.0, so check if it exists before setting it.
		if ( property_exists( $this, 'email_group' ) ) {
			$this->email_group = WC_Booking_Email_Manager::EMAIL_GROUP;
		}
