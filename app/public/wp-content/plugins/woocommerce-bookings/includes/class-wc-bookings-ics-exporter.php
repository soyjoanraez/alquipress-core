...
class WC_Bookings_ICS_Exporter {
	...
	protected function create() {
		...
		$handle = @fopen( $this->file_path, 'w' ); // phpcs:ignore WordPress.WP.AlternativeFunctions.file_system_operations_fopen, WordPress.PHP.NoSilencedErrors.Discouraged
		$ics = $this->generate();
		@fwrite( $handle, $ics ); // phpcs:ignore WordPress.WP.AlternativeFunctions.file_system_operations_fwrite, WordPress.PHP.NoSilencedErrors.Discouraged
