...
class WC_Bookings_Save_Meta_Box {
	...
	public function meta_box_inner( $post ) {
		...
		<input type="submit" class="button save_order button-primary tips" name="save" value="<?php esc_attr_e( 'Save Booking', 'woocommerce-bookings' ); ?>" data-tip="<?php echo wc_sanitize_tooltip( __( 'Save/update the booking', 'woocommerce-bookings' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>" />
