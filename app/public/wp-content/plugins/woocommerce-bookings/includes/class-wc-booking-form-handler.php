...
/**
 * WC_Booking_Form_Handler class.
 *
 * Handles frontend booking forms.
 */
class WC_Booking_Form_Handler {
	...
	public static function cancel_booking() {
		if ( isset( $_GET['cancel_booking'] ) && isset( $_GET['booking_id'] ) ) {
			...
			$redirect           = esc_url_raw( wp_unslash( $_GET['redirect'] ) ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotValidated
