...
class WC_Bookings_REST_Products_Controller extends WC_REST_Products_Controller {
	...
	protected function get_product_data( $product, $context = 'view' ) {
		...
		// Remove `meta_data` from the response for the unauthorized user.
		$post_type_object = get_post_type_object( 'wc_booking' );
		$permission       = current_user_can( $post_type_object->cap->read_private_posts, $product->get_id() );
		if ( ! $permission && isset( $data['meta_data'] ) ) {
